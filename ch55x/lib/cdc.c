        ...
        case UIS_TOKEN_SETUP | 0:
            ...
            if(len == (sizeof(USB_SETUP_REQ))) {
                ...
                if ( ( UsbSetupBuf->bRequestType & USB_REQ_TYP_MASK ) != USB_REQ_TYP_STANDARD ) {
                    ...
                    case SET_CONTROL_LINE_STATE: break; //0x22  generates RS-232/V.24 style control signals

                    case SET_LINE_CODING: break;     //0x20  Configure                        
                    ...
                    case USB_GET_STATUS:
                        Ep0Buffer[0] = 0x00;
                        Ep0Buffer[1] = 0x00;
                        if ( SetupLen >= 2 ) len = 2; else len = SetupLen;
                        break;
