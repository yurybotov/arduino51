...
byte digitalRead(byte pin) {
    switch(GPIO_PORT(pin)) {
        case 0: return bitRead(P0, GPIO_PIN(pin));
...
void digitalWrite(byte pin, byte value) {
    switch(GPIO_PORT(pin)) {
        case 0: bitWrite(P0, (GPIO_PIN(pin)), value); break;
...
void analogWrite(byte pin, word value) {
    if (GPIO_PORT(pin) == 0) {
        switch (GPIO_PIN(pin)) {
        case 0: PWM3H = highByte(value); PWM3L = lowByte(value); break;
        case 1: set_SFRPAGE; PWM4H = highByte(value); PWM4L = lowByte(value); clr_SFRPAGE; break;
        case 3: set_SFRPAGE; PWM5H = highByte(value); PWM5L = lowByte(value); clr_SFRPAGE; break;
        case 4: PWM3H = highByte(value); PWM3L = lowByte(value); break;
        case 5: PWM2H = highByte(value); PWM2L = lowByte(value); break;
        default: break;
        }
    } else if (GPIO_PORT(pin) == 1) {
        switch (GPIO_PIN(pin)) {
        case 0: PWM2H = highByte(value); PWM2L = lowByte(value); break;
        case 1: PWM2H = highByte(value); PWM2L = lowByte(value); break;
        case 2: PWM0H = highByte(value); PWM0L = lowByte(value); break;
        case 4: PWM1H = highByte(value); PWM1L = lowByte(value); break;
        case 5: set_SFRPAGE; PWM5H = highByte(value); PWM5L = lowByte(value); clr_SFRPAGE; break;
        default: break;
        }
    } else
        return;
